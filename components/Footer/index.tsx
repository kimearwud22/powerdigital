      ...
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                Kami percaya bahwa setiap orang memiliki potensi untuk menjadi lebih baik.
                </p>
          ...
          <div className="py-8">
            ...
            © Copyright Power Digital Technology 2023{" "}
              <a href="https://powerdigital.id" rel="nofollow noopener">
              Designed by powerdigital.id
              </a>
            </p>
          </div>
        </div>
